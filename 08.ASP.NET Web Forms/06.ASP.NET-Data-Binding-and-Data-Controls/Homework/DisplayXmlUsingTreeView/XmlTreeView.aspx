<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XmlTreeView.aspx.cs" Inherits="_6.DisplayXmlUsingTreeView.XmlTreeView" enableEventValidation="false" %>
...
<body>
    <form id="XMLTreeView" runat="server">
        ...
        <asp:TreeView ID="TreeViewXml" ImageSet="Arrows" runat="server" DataSourceID="XmlDataSourceBooks"
            OnTreeNodeDataBound="TreeViewXml_TreeNodeDataBound"  OnSelectedNodeChanged="TreeViewXml_SelectedNodeChanged">
        </asp:TreeView>
