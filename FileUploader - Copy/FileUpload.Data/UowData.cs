...
namespace FileUpload.Data
{
    ...
    public class UowData : IUowData
    {
        ...
        /// <summary>
        /// Gets the trace log messages.
        /// </summary>
        /// <value>The trace log messages.</value>
        public IRepository<TraceLogMessage, int> TraceLogMessages
        {
            get
            {
                return this.GetRepository<TraceLogMessage, int>();
            }
        }
