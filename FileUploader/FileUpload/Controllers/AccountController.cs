...
namespace FileUpload.Controllers
{
    ...
    {
        private FileUpload.App_Start.ApplicationUserManager _userManager;

        public AccountController()
        {
        }

        public AccountController(FileUpload.App_Start.ApplicationUserManager userManager)
        {
            UserManager = userManager;
        }

        public FileUpload.App_Start.ApplicationUserManager UserManager 
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<FileUpload.App_Start.ApplicationUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Не съществува такъв потребител.");
                    return View();
                }
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.RemoveLoginSuccess ? "Акаунта беше премахнат"
